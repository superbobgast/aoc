...
def drawLine(current_location, new_location, drawing):
    ...
    print(current_location,new_location)
    drawing[rr, cc] = 1
    return drawing
...
def drawWires(tuples, drawing, centroid):
    ...
    count = 0
    for t in tuples:
        # print("Leng:{}, count:{}".format(len(tuples),count))
        count = count + 1
        direction = t[0]
        steps = t[1]
        ...
        if direction == "R":
            ...
            # print("Up:{}".format(steps))
            y1 = y1 + steps
        elif direction == "D":
            # print("Down:{}".format(steps))
            y1 = y1 - steps
        else:
